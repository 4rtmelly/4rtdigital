      ...
      <div className="mx-auto flex flex-col items-center justify-center font-sans">
        ...
        <div className="w-3/5 flex flex-col items-center justify-center font-sans mt-10">
          <p
            ...
            before:-z-10 italic text-white text-4xl uppercase font-bold md:text-5xl"
          >
            {" "}
          ...
          <p className="mt-10 font-sans text-lg text-white">
            ...
            <span className="font-bold italic text-2xl underline">
              visibility
            </span>{" "}
            for artists. Allowing them to share their artworks about a same
            topic in a collective 3D canvas that mixes different styles. <br />{" "}
            A rotation of artists, artworks and topics is made monthly.
          </p>
        </div>
        <div className="w-4/5 h-screen flex flex-col items-center justify-center">
          <div className="w-full flex flex-col items-center justify-center mt-10 ">
            ...
            <div className="w-3/5 bg-stone-50 w-1/5 mt-4 flex flex-row items-center justify-center rounded-full md:w-1/5 ">
              <Link href="./artworks">
                <BlurText
